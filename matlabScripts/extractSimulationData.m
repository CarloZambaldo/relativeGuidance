function dataExtracted = extractSimulationData(data, simulationID)
    ...
    dataExtracted.targetTrajectory_S = data.targetTrajectory_S(:, :, simulationID);
    dataExtracted.trueRelativeStateHistory_L = data.trueRelativeStateHistory_L(:,:,simulationID);
